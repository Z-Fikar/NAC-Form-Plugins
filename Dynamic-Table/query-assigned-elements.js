...
const e$3 = window,
  ...
  a$1 = (t, i) => i !== t && (i == i || t == t),
  l$2 = { attribute: !0, type: String, converter: n$3, reflect: !1, hasChanged: a$1 };
  ...
  _$AK(t, i) {
    ...
    if (void 0 !== r && this._$El !== r) {
      const t = e.getPropertyOptions(r),
        h = "function" == typeof t.converter ? { fromAttribute: t.converter } : void 0 !== (null === (s = t.converter) || void 0 === s ? void 0 : s.fromAttribute) ? t.converter : n$3;
...
(d$1.finalized = !0), (d$1.elementProperties = new Map()), (d$1.elementStyles = []), (d$1.shadowRootOptions = { mode: "open" }), null == o$2 || o$2({ ReactiveElement: d$1 }), (null !== (s$2 = e$3.reactiveElementVersions) && void 0 !== s$2 ? s$2 : (e$3.reactiveElementVersions = [])).push("1.6.1");
  ...
  E = (t, i) => {
    ...
    for (let i = 0; i < s; i++) {
      ...
      for (; g < s.length && ((d.lastIndex = g), (u = d.exec(s)), null !== u); )
        (g = d.lastIndex), d === v ? ("!--" === u[1] ? (d = a) : void 0 !== u[1] ? (d = f) : void 0 !== u[2] ? ($.test(u[2]) && (h = RegExp("</" + u[2], "g")), (d = _)) : void 0 !== u[3] && (d = _)) : d === _ ? (">" === u[0] ? ((d = null != h ? h : v), (c = -1)) : void 0 === u[1] ? (c = -2) : ((c = d.lastIndex - u[2].length), (e = u[1]), (d = void 0 === u[3] ? _ : '"' === u[3] ? p : m))) : d === p || d === m ? (d = _) : d === a || d === f ? (d = v) : ((d = _), (h = void 0));
      ...
      if (1 === l.nodeType) {
            ...
            if (i.endsWith("$lit$") || i.startsWith(o$1)) {
              ...
              if ((t.push(i), void 0 !== s)) {
                const t = l.getAttribute(s.toLowerCase() + "$lit$").split(o$1),
                  i = /([.?@])?(.*)/.exec(s);
                c.push({ type: 1, index: h, name: i[2], strings: t, ctor: "." === i[1] ? M : "?" === i[1] ? k : "@" === i[1] ? H : S });
        ...
        if ($.test(l.tagName)) {
          ...
          if (i > 0) {
            ...
            for (let s = 0; s < i; s++) l.append(t[s], r()), A.nextNode(), c.push({ type: 2, index: ++h });
            l.append(t[i], r());
          }
        }
        ...
        if (l.data === n$2) c.push({ type: 2, index: h });
          ...
          let t = -1;
          for (; -1 !== (t = l.data.indexOf(o$1, t + 1)); ) c.push({ type: 7, index: h }), (t += o$1.length - 1);
        }
      h++;
    }
  }
...
const L = { P: "$lit$", A: o$1, M: n$2, C: 1, L: E, R: V, D: c, V: P, I: N, H: S, N: k, U: H, B: M, F: I },
  z = i$1.litHtmlPolyfillSupport;
null == z || z(C, N), (null !== (t = i$1.litHtmlVersions) && void 0 !== t ? t : (i$1.litHtmlVersions = [])).push("2.6.1");
const Z = (t, i, s) => {
  var e, o;
...
(s.finalized = !0), (s._$litElement$ = !0), null === (l = globalThis.litElementHydrateSupport) || void 0 === l || l.call(globalThis, { LitElement: s });
...
export { L, _decorate as _, e$1 as a, b, e, i$2 as i, s, x, y };
